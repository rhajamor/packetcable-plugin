...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "pcmm-service-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:pcmm-service:impl";
    private final String revision = "2014-08-10";
    private final String resourcePath = "/META-INF/yang/pcmm-service-impl.yang";
