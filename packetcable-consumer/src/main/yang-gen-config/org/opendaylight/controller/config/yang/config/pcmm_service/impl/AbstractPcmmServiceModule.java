...
public abstract class AbstractPcmmServiceModule implements org.opendaylight.controller.config.spi.Module,org.opendaylight.controller.config.yang.config.pcmm_service.impl.PcmmServiceModuleMXBean,org.opendaylight.controller.config.yang.config.pcmm_service.impl.PcmmServiceServiceInterface,org.opendaylight.controller.config.api.RuntimeBeanRegistratorAwareModule {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(org.opendaylight.controller.config.yang.config.pcmm_service.impl.AbstractPcmmServiceModule.class);
    ...
    public AbstractPcmmServiceModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
    ...
    public AbstractPcmmServiceModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractPcmmServiceModule oldModule,java.lang.AutoCloseable oldInstance) {
        this.identifier = identifier;
        this.dependencyResolver = dependencyResolver;
    ...
    private org.opendaylight.controller.config.yang.config.pcmm_service.impl.PcmmServiceRuntimeRegistrator rootRuntimeBeanRegistratorWrapper;

    public org.opendaylight.controller.config.yang.config.pcmm_service.impl.PcmmServiceRuntimeRegistrator getRootRuntimeBeanRegistratorWrapper(){
    ...
    public void setRuntimeBeanRegistrator(org.opendaylight.controller.config.api.runtime.RootRuntimeBeanRegistrator rootRuntimeRegistrator){
        this.rootRuntimeBeanRegistratorWrapper = new org.opendaylight.controller.config.yang.config.pcmm_service.impl.PcmmServiceRuntimeRegistrator(rootRuntimeRegistrator);
    }
