...
public abstract class AbstractPacketcableProviderModule implements org.opendaylight.controller.config.spi.Module,org.opendaylight.controller.config.yang.config.packetcable_provider.impl.PacketcableProviderModuleMXBean,org.opendaylight.controller.config.api.RuntimeBeanRegistratorAwareModule {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(org.opendaylight.controller.config.yang.config.packetcable_provider.impl.AbstractPacketcableProviderModule.class);
    ...
    private final AbstractPacketcableProviderModule oldModule;
    ...
    public AbstractPacketcableProviderModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
    ...
    public AbstractPacketcableProviderModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractPacketcableProviderModule oldModule,java.lang.AutoCloseable oldInstance) {
        this.identifier = identifier;
        this.dependencyResolver = dependencyResolver;
    ...
    private org.opendaylight.controller.config.yang.config.packetcable_provider.impl.PacketcableProviderRuntimeRegistrator rootRuntimeBeanRegistratorWrapper;

    public org.opendaylight.controller.config.yang.config.packetcable_provider.impl.PacketcableProviderRuntimeRegistrator getRootRuntimeBeanRegistratorWrapper(){
    ...
    public void setRuntimeBeanRegistrator(org.opendaylight.controller.config.api.runtime.RootRuntimeBeanRegistrator rootRuntimeRegistrator){
        this.rootRuntimeBeanRegistratorWrapper = new org.opendaylight.controller.config.yang.config.packetcable_provider.impl.PacketcableProviderRuntimeRegistrator(rootRuntimeRegistrator);
    }
    ...
    public boolean canReuseInstance(AbstractPacketcableProviderModule oldModule){
    ...
    public boolean isSame(AbstractPacketcableProviderModule other) {
        if (other == null) {
    ...
    public boolean equals(Object o) {
        ...
        AbstractPacketcableProviderModule that = (AbstractPacketcableProviderModule) o;
