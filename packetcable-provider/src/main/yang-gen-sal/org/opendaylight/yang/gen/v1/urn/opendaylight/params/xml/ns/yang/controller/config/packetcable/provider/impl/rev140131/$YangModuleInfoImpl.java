...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "packetcable-provider-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:packetcable-provider:impl";
    private final String revision = "2014-01-31";
    private final String resourcePath = "/META-INF/yang/packetcable-provider-impl.yang";
